...
const CACHE_NAME = 'astragalomancy-v0.8.0';
const STATIC_CACHE_NAME = 'astragalomancy-static-v0.8.0';
const DYNAMIC_CACHE_NAME = 'astragalomancy-dynamic-v0.8.0';
...
const STATIC_ASSETS = [
  ...
  '/js/Main.js',
  '/js/game/GamePersistence.js',
  '/js/game/GameEngine.js',
  '/js/engine/ShopStockGenerator.js',
  '/js/classes/Die.js',
  '/js/classes/Card.js',
  '/js/classes/BoonDisplayStats.js',
  '/js/classes/Boon.js',
