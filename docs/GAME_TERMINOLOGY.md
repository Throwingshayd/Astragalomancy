...
The three pack families follow Balatro's pack vouchers. Tier 1 adds one extra card of that type in the matching pack (Hall of Heroes / Panegyris / Symposium). Tier 2 for worship and libations is **The Bird Omens** / **Ganymede's Cup**: the pack always contains a Blessing for your highest god, or your most-poured Libation. Boon packs upgrade into **Antikythra** (+1 Boon slot) instead. Seed of Plutus / Grove of Plutus raise the interest *cap* (5 → 10 → 20), never the gold-per-5 rate.
...
**Hades** is **The House** (internal key `Yahtzee`, five of a kind). **Zeus** (Most High) is **Heureka** (six of a kind). **Iris** is **The Spectrum** (internal key `Extra Long Straight`, run of six). Sevens–Nines, The Spectrum, Heureka, and the extra dice open from **The Jar**, not from rolling the hand.
